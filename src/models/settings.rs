...
impl Default for Settings {
    fn default() -> Self {
        Self {
            id: Uuid::new_v4(),
            user_id: Uuid::nil(),
            ocr_language: std::env::var("OCR_LANGUAGE").unwrap_or_else(|_| "vie+eng".to_string()),
            preferred_languages: vec!["vie".to_string(), "eng".to_string()],
            primary_language: "vie".to_string(),
